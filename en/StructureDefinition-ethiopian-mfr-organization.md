# Ethiopian MFR Organization - Ethiopia Base Implementation Guide v0.9.0

## Resource Profile: Ethiopian MFR Organization 

 
An organization (health facility or administrative body) registered in the Ethiopian Master Facility Registry (MFR), including its MFR and license identifiers, contacts, and parent organization. 
